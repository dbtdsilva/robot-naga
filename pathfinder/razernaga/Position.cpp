...
Position::Position() : x_(0), y_(0), out_left_(0), out_right_(0) {
...
void Position::update_position(const double& theta, const double& in_left, const double& in_right) {
    ...
    double out_left_t = in_left * 0.5 + out_left_ * 0.5;
    double out_right_t = in_right * 0.5 + out_right_ * 0.5;
    ...
    out_left_ = out_left_t;
    out_right_ = out_right_t;
