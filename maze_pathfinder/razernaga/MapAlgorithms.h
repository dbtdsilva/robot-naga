...
public:
    ...
    std::vector<std::tuple<int, int>> astar_shortest_path(const std::tuple<int, int>&, const std::tuple<int, int>&, bool) const;
    std::vector<std::tuple<int, int>> flood_fill(const std::tuple<int, int>&, const int& minimum_distance = 0, const int& safe_distance = 0) const;
